  ...
  pack: {
    ...
    packItems: [
      ...
      },
      {
        ...
        description:
          'Once you have your sleeping arrangements and apparel squared away, the experts say you’ll want to think about your camp kitchen. While some campgrounds have grills at each site, a lot do not, so if you’re planning for a few days (or more), you’ll probably want to bring your own portable stove.',
      },
    ],
  },
})
